class TiersController < ApplicationController
  ...
  def setup_tier
    ...
    @items.each do |item|
      ...
      filename_with_extension = item.image.filename.to_s
      filename = File.basename(filename_with_extension, File.extname(filename_with_extension))
      ...
      @images_map[rank_category_key] << item.image_data(variant_url, filename)
    end
  end
